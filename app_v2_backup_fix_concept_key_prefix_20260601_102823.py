...
def render_concept_finder(items):
    ...
    with add_col1:
        st.text_input(
            ...
            key="pkm_new_concept_name_finder",
        )
    with add_col2:
        st.text_input(
            "폴더 경로",
            placeholder="예: 마케팅/프레임워크",
            key="pkm_new_concept_folder_finder",
        )
    with add_col3:
        st.write("")
        st.write("")
        st.button(
            ...
            args=("pkm_new_concept_name_finder", "pkm_new_concept_folder_finder"),
        )
...
def render_knowledge_map_page():
    ...
    with st.expander("🛠️ 핵심 개념 직접 관리", expanded=False):
        ...
        new_folder = st.text_input("개념 폴더", placeholder="예: 마케팅 / 기술 / 정책 / 취업", key="pkm_new_concept_folder_finder")
