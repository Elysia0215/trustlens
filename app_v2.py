...
""", unsafe_allow_html=True)
    ...
    <div style="font-weight:700; color:#1e293b; margin-top:6px;">{_v['title']}</div>
        ...
        _roadmap = [
            ("v4.0", "Semantic Merge · AI 의미 병합 + 판단 패턴", "신경망/신경망 구조/뉴럴 네트워크를 의미 유사도로 병합 + 홈을 ‘오늘 성장한 개념·최근 연결된 지식’ 중심으로, 판단 히스토리에서 사고 구조 발견", "진행 예정"),
...
""")
    ...
    <div style="background:#e2e8f0; border-radius:6px; height:9px; margin-top:3px;">
        ...
        st.info("👉 다음 전략: **의미 병합(v4.0) → 사고 인바디(v4.x)** 로 ‘내 사고 구조를 읽어주는 지식 OS’를 향해 확장.")
        st.divider()
        ...
        _timeline = [
            ...
            ("2026-06", "v3.9 · Control Center", "발견 가능한 제품", "설정 통합(화면·세계관·루미·기능·실험실) + 사이드바 정리", "#6d28d9", True),
            ("예정", "v4.0 → v4.x", "Knowledge OS 완성", "의미 병합 → 사고 인바디(철학 프로파일)", "#7c3aed", False),
        ]
